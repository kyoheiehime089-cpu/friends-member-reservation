-- Production hotfix: enforce booking rules at DB trigger level.
-- Safe rules: no drop table, no truncate, no delete from, no existing data deletion.
-- This prevents API or browser bypasses from creating invalid booked reservations.
