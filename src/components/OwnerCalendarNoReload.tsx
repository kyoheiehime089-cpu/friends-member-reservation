...
export function OwnerCalendarNoReload() {
  ...
  async function cancelReservation(reservationId: string) {
    ...
    try {
      ...
      removeReservationFromView(reservationId, result.reservation?.member_id, result.reservation?.reservation_slot_id);
